...
#ifdef SOFA_BUILD_SOFACOMMON
#  define  SOFA_TARGET    SofaCommon
#  define SOFA_SOFACOMMON_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
#  define SOFA_SOFACOMMON_API SOFA_IMPORT_DYNAMIC_LIBRARY
#endif
...
#define SOFAEIGEN2SOLVER_HAVE_OPENMP 0
