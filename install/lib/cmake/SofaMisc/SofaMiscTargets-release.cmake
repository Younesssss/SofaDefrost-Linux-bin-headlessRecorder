...
set_target_properties(SofaMiscExtra PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscExtra.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscExtra.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscExtra )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscExtra "${_IMPORT_PREFIX}/lib/libSofaMiscExtra.so.20.06.99" )
...
set_target_properties(SofaMiscEngine PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscEngine.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscEngine.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscEngine )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscEngine "${_IMPORT_PREFIX}/lib/libSofaMiscEngine.so.20.06.99" )
...
set_target_properties(SofaMiscFem PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscFem.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscFem.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscFem )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscFem "${_IMPORT_PREFIX}/lib/libSofaMiscFem.so.20.06.99" )
...
set_target_properties(SofaMiscForceField PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscForceField.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscForceField.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscForceField )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscForceField "${_IMPORT_PREFIX}/lib/libSofaMiscForceField.so.20.06.99" )
...
set_target_properties(SofaMiscMapping PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscMapping.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscMapping.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscMapping )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscMapping "${_IMPORT_PREFIX}/lib/libSofaMiscMapping.so.20.06.99" )
...
set_target_properties(SofaMiscSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscSolver.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscSolver.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscSolver "${_IMPORT_PREFIX}/lib/libSofaMiscSolver.so.20.06.99" )
...
set_target_properties(SofaMiscTopology PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMiscTopology.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMiscTopology.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMiscTopology )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMiscTopology "${_IMPORT_PREFIX}/lib/libSofaMiscTopology.so.20.06.99" )
...
set_target_properties(SofaMisc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMisc.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMisc.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMisc )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMisc "${_IMPORT_PREFIX}/lib/libSofaMisc.so.20.06.99" )
