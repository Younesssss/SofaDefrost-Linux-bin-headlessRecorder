...
set_target_properties(SofaGuiCommon PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaGuiCommon.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaGuiCommon.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaGuiCommon )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaGuiCommon "${_IMPORT_PREFIX}/lib/libSofaGuiCommon.so.19.06.99" )
...
set_target_properties(SofaHeadlessRecorder PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaHeadlessRecorder.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaHeadlessRecorder.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaHeadlessRecorder )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaHeadlessRecorder "${_IMPORT_PREFIX}/lib/libSofaHeadlessRecorder.so.19.06.99" )
...
set_target_properties(SofaGuiQt PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "SofaExporter"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaGuiQt.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaGuiQt.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaGuiQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaGuiQt "${_IMPORT_PREFIX}/lib/libSofaGuiQt.so.19.06.99" )
...
set_target_properties(SofaGuiMain PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaGuiMain.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaGuiMain.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaGuiMain )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaGuiMain "${_IMPORT_PREFIX}/lib/libSofaGuiMain.so.19.06.99" )
