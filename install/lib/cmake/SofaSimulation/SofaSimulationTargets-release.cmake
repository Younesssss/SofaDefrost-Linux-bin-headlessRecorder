...
set_target_properties(SofaSimulationCommon PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimulationCommon.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaSimulationCommon.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimulationCommon )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimulationCommon "${_IMPORT_PREFIX}/lib/libSofaSimulationCommon.so.19.06.99" )
...
set_target_properties(SofaSimulationTree PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimulationTree.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaSimulationTree.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimulationTree )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimulationTree "${_IMPORT_PREFIX}/lib/libSofaSimulationTree.so.19.06.99" )
...
set_target_properties(SofaSimulationGraph PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimulationGraph.so.19.06.99"
  IMPORTED_SONAME_RELEASE "libSofaSimulationGraph.so.19.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimulationGraph )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimulationGraph "${_IMPORT_PREFIX}/lib/libSofaSimulationGraph.so.19.06.99" )
