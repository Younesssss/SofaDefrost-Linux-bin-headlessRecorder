...
set_target_properties(SofaDeformable PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaDeformable.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaDeformable.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaDeformable )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaDeformable "${_IMPORT_PREFIX}/lib/libSofaDeformable.so.20.06.99" )
...
set_target_properties(SofaEngine PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaEngine.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaEngine.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaEngine )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaEngine "${_IMPORT_PREFIX}/lib/libSofaEngine.so.20.06.99" )
...
set_target_properties(SofaExplicitOdeSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaExplicitOdeSolver.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaExplicitOdeSolver.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaExplicitOdeSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaExplicitOdeSolver "${_IMPORT_PREFIX}/lib/libSofaExplicitOdeSolver.so.20.06.99" )
...
set_target_properties(SofaImplicitOdeSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaImplicitOdeSolver.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaImplicitOdeSolver.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaImplicitOdeSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaImplicitOdeSolver "${_IMPORT_PREFIX}/lib/libSofaImplicitOdeSolver.so.20.06.99" )
...
set_target_properties(SofaLoader PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaLoader.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaLoader.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaLoader )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaLoader "${_IMPORT_PREFIX}/lib/libSofaLoader.so.20.06.99" )
...
set_target_properties(SofaMeshCollision PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMeshCollision.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaMeshCollision.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMeshCollision )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMeshCollision "${_IMPORT_PREFIX}/lib/libSofaMeshCollision.so.20.06.99" )
...
set_target_properties(SofaObjectInteraction PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaObjectInteraction.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaObjectInteraction.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaObjectInteraction )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaObjectInteraction "${_IMPORT_PREFIX}/lib/libSofaObjectInteraction.so.20.06.99" )
...
set_target_properties(SofaRigid PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaRigid.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaRigid.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaRigid )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaRigid "${_IMPORT_PREFIX}/lib/libSofaRigid.so.20.06.99" )
...
set_target_properties(SofaSimpleFem PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimpleFem.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaSimpleFem.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimpleFem )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimpleFem "${_IMPORT_PREFIX}/lib/libSofaSimpleFem.so.20.06.99" )
...
set_target_properties(SofaEigen2Solver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaEigen2Solver.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaEigen2Solver.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaEigen2Solver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaEigen2Solver "${_IMPORT_PREFIX}/lib/libSofaEigen2Solver.so.20.06.99" )
...
set_target_properties(SofaCommon PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaCommon.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaCommon.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaCommon )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaCommon "${_IMPORT_PREFIX}/lib/libSofaCommon.so.20.06.99" )
