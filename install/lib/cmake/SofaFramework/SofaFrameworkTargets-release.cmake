...
set_target_properties(SofaHelper PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaHelper.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaHelper.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaHelper )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaHelper "${_IMPORT_PREFIX}/lib/libSofaHelper.so.20.06.99" )
...
set_target_properties(SofaDefaultType PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaDefaultType.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaDefaultType.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaDefaultType )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaDefaultType "${_IMPORT_PREFIX}/lib/libSofaDefaultType.so.20.06.99" )
...
set_target_properties(SofaCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaCore.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaCore.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaCore "${_IMPORT_PREFIX}/lib/libSofaCore.so.20.06.99" )
...
set_target_properties(SofaSimulationCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimulationCore.so.20.06.99"
  IMPORTED_SONAME_RELEASE "libSofaSimulationCore.so.20.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimulationCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimulationCore "${_IMPORT_PREFIX}/lib/libSofaSimulationCore.so.20.06.99" )
